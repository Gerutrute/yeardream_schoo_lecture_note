...
| ID   | NAME       | CLASS_ID | CLASS_ID_1 | CLASS |
| ---- | ---------- | -------- | ---------- | ----- |
| 1000 | 모자장수   | 001      | 001        | A     |
| 1001 | 앨리스 토끼 | 002      | 001        | A     |
| 1002 | 체셔       | 002      | 002        | B     |
| 1003 | 도도새     | 003      |            |       |

OURTER JOIN(FULL OUTER JOIN)
...
---
Q. 각 JOIN에 따른 키 값의 조합과 출력되는 행의 갯수는?
INNER JOIN : 2
...
INNER JOIN
- JOIN을 활용한 쿼리에서도 WHERE문을 추가가 가능
